...
<head>
    ...
    <title>Products - Dainty Dream</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
                ...
                <tbody>
                    @foreach ($products as $product)
                        <tr>
                            ...
                            <td><span style="background: #e0f2fe; padding: 5px 10px; border-radius: 5px;">{{ $product->stock }}</span></td>
                            <td>{{ $product->condition_status ?? '-' }}</td>
                            <td>
                                <div class="actions">
                                    <a href="{{ url('/products/' . $product->id . '/edit') }}" class="btn-sm btn-edit">Edit</a>
        ...
        @else
            <div class="empty-state">
                ...
                <a href="{{ url('/products/create') }}" class="btn-add">Add your first product</a>
            </div>
        @endif
    </div>
</body>
