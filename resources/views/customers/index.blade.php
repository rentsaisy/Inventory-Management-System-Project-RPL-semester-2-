...
<head>
    ...
    <title>Customers - Dainty Dream</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
                ...
                <tbody>
                    @foreach ($customers as $customer)
                        <tr>
                            ...
                            <td>
                                <div class="actions">
                                    <a href="{{ url('/customers/' . $customer->id . '/edit') }}" class="btn-sm btn-edit">Edit</a>
        ...
        @else
            <div class="empty-state">
                ...
                <a href="{{ url('/customers/create') }}" class="btn-add">Add your first customer</a>
            </div>
        @endif
    </div>
</body>
